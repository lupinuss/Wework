...
/**
 * Created by luyufa on 2019/4/9.
 */

public class WeChatWork {

    private static String TAG = "WeChatWork";
    ...
    public static void hook() {
        ...
        XposedHelpers.findAndHookMethod(Application.class, "attach", Context.class, new XC_MethodHook() {
            ...
            protected void afterHookedMethod(MethodHookParam param) throws Throwable {
                ...
                Log.e(TAG, "开始hook微信企业版");

                ClassLoader classLoader = ((Context) param.args[0]).getClassLoader();

                XSharedPreferences xsp = new XSharedPreferences("com.lupinus.wework","HookInfo");
                xsp.makeWorldReadable();

                String latitude = xsp.getString("latitude","");
                String longitude = xsp.getString("longitude","");
                int lac = xsp.getInt("lac",0);
                int cid = xsp.getInt("cid",0);
                String bssid = xsp.getString("bssid","");
    ...
    private static void wifi(ClassLoader classLoader, final String bssid, final String ssid){
    ...
    private static void location(ClassLoader classLoader, final double latitude, final double longtitude, final int lac, final int cid) {
